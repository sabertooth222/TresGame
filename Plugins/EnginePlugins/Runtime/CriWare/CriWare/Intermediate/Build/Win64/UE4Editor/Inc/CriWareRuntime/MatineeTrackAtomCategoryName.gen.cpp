...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UMatineeTrackAtomCategoryName()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_bEnableVolumeTrack = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bEnableVolumeTrack"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bEnableVolumeTrack, UMatineeTrackAtomCategoryName), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(bEnableVolumeTrack, UMatineeTrackAtomCategoryName), sizeof(bool), true);
				UProperty* NewProp_CategoryName = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("CategoryName"), RF_Public|RF_Transient|RF_MarkAsNative) UStrProperty(CPP_PROPERTY_BASE(CategoryName, UMatineeTrackAtomCategoryName), 0x0010000000000005);
				...
				MetaData->SetValue(NewProp_bEnableVolumeTrack, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(UMatineeTrackAtomCategoryName, 2566506879);
