...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UMatineeTrackAtomSoundBase()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				MetaData->SetValue(NewProp_bContinueSoundOnMatineeEnd, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(UMatineeTrackAtomSoundBase, 2665280342);
