...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UMovieSceneAtomSection()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_bSuppressSubtitles = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bSuppressSubtitles"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bSuppressSubtitles, UMovieSceneAtomSection), 0x0040000000000005, CPP_BOOL_PROPERTY_BITMASK(bSuppressSubtitles, UMovieSceneAtomSection), sizeof(bool), true);
				UProperty* NewProp_PitchMultiplier = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("PitchMultiplier"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(PitchMultiplier, UMovieSceneAtomSection), 0x0040000000000005, Z_Construct_UScriptStruct_FRichCurve());
				UProperty* NewProp_SoundVolume = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("SoundVolume"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(SoundVolume, UMovieSceneAtomSection), 0x0040000000000005, Z_Construct_UScriptStruct_FRichCurve());
				UProperty* NewProp_StartOffset = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("StartOffset"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(StartOffset, UMovieSceneAtomSection), 0x0040000000000005);
				UProperty* NewProp_Sound = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Sound"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(Sound, UMovieSceneAtomSection), 0x0040000000000005, Z_Construct_UClass_USoundAtomCue_NoRegister());
				...
				MetaData->SetValue(NewProp_bSuppressSubtitles, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_SoundVolume, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_StartOffset, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_Sound, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(UMovieSceneAtomSection, 1034542780);
