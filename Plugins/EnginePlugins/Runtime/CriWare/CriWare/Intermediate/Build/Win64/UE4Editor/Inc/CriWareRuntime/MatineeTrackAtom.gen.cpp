...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UMatineeTrackAtom()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_SelectorList = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("SelectorList"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(SelectorList, UMatineeTrackAtom), 0x0010000000000005);
				...
				UProperty* NewProp_AisacList = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("AisacList"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(AisacList, UMatineeTrackAtom), 0x0010000000000005);
	...
	IMPLEMENT_CLASS(UMatineeTrackAtom, 1191660737);
