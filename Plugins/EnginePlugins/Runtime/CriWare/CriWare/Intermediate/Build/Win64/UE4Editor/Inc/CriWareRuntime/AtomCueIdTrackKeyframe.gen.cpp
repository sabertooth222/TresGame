...
static struct FScriptStruct_CriWareRuntime_StaticRegisterNativesFAtomCueIdTrackKeyframe
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FAtomCueIdTrackKeyframe()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_CueId = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("CueId"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(CueId, FAtomCueIdTrackKeyframe), 0x0010000000000005);
			UProperty* NewProp_Time = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Time"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Time, FAtomCueIdTrackKeyframe), 0x0010000000000005);
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("BlueprintType"), TEXT("true"));
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/AtomCueIdTrackKeyframe.h"));
			MetaData->SetValue(NewProp_CueId, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FAtomCueIdTrackKeyframe_CRC() { return 2020862894U; }
