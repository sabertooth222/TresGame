...
static struct FScriptStruct_CriWareRuntime_StaticRegisterNativesFAtomTrackKeyframe
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FAtomTrackKeyframe()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_Cue = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Cue"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(Cue, FAtomTrackKeyframe), 0x0010000000000005, Z_Construct_UClass_USoundAtomCue_NoRegister());
			UProperty* NewProp_Time = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Time"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Time, FAtomTrackKeyframe), 0x0010000000000005);
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("BlueprintType"), TEXT("true"));
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/AtomTrackKeyframe.h"));
			MetaData->SetValue(NewProp_Cue, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FAtomTrackKeyframe_CRC() { return 1357948443U; }
