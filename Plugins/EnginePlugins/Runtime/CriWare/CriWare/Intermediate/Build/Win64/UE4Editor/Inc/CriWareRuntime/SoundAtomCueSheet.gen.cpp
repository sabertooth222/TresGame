...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_USoundAtomCueSheet()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_AwbDirectory = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("AwbDirectory"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(AwbDirectory, USoundAtomCueSheet), 0x0010000000000005, Z_Construct_UScriptStruct_FDirectoryPath());
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bOverrideAwbDirectory, USoundAtomCueSheet);
				UProperty* NewProp_bOverrideAwbDirectory = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bOverrideAwbDirectory"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bOverrideAwbDirectory, USoundAtomCueSheet), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(bOverrideAwbDirectory, USoundAtomCueSheet), sizeof(bool), true);
				...
				MetaData->SetValue(NewProp_AwbDirectory, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_bOverrideAwbDirectory, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(USoundAtomCueSheet, 253529912);
