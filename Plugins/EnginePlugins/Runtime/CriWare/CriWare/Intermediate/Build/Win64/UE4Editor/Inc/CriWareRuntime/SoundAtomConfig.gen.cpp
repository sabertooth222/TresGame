...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_USoundAtomConfig()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_AcfFilePath = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("AcfFilePath"), RF_Public|RF_Transient|RF_MarkAsNative) UStrProperty(CPP_PROPERTY_BASE(AcfFilePath, USoundAtomConfig), 0x0010000000000005);
				...
				MetaData->SetValue(NewProp_AcfFilePath, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(USoundAtomConfig, 833073166);
