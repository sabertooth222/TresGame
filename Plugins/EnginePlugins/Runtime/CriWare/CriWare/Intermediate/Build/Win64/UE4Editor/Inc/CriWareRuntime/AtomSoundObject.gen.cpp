...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UAtomSoundObject()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_EnableCategoryCueLimitScope = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("EnableCategoryCueLimitScope"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(EnableCategoryCueLimitScope, UAtomSoundObject), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(EnableCategoryCueLimitScope, UAtomSoundObject), sizeof(bool), true);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(EnableVoiceLimitScope, UAtomSoundObject);
				UProperty* NewProp_EnableVoiceLimitScope = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("EnableVoiceLimitScope"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(EnableVoiceLimitScope, UAtomSoundObject), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(EnableVoiceLimitScope, UAtomSoundObject), sizeof(bool), true);
				...
				MetaData->SetValue(NewProp_EnableCategoryCueLimitScope, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_EnableVoiceLimitScope, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(UAtomSoundObject, 1307825921);
