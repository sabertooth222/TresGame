...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UAtomComponent()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_DefaultSelectorLabel = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("DefaultSelectorLabel"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(DefaultSelectorLabel, UAtomComponent), 0x0010000000000005);
				...
				UProperty* NewProp_DefaultAisacControl = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("DefaultAisacControl"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(DefaultAisacControl, UAtomComponent), 0x0010000000000005);
				...
				UProperty* NewProp_DefaultBlockIndex = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("DefaultBlockIndex"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(DefaultBlockIndex, UAtomComponent), 0x0010000000000005);
				UProperty* NewProp_DefaultSoundObject = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("DefaultSoundObject"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(DefaultSoundObject, UAtomComponent), 0x0010000000000005, Z_Construct_UClass_UAtomSoundObject_NoRegister());
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bEnableMultipleSoundPlayback, UAtomComponent);
				UProperty* NewProp_bEnableMultipleSoundPlayback = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bEnableMultipleSoundPlayback"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bEnableMultipleSoundPlayback, UAtomComponent), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(bEnableMultipleSoundPlayback, UAtomComponent), sizeof(bool), true);
				UProperty* NewProp_DefaultVolume = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("DefaultVolume"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(DefaultVolume, UAtomComponent), 0x0010000000000005);
				...
				MetaData->SetValue(NewProp_DefaultSelectorLabel, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_DefaultAisacControl, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_DefaultBlockIndex, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_DefaultSoundObject, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_bEnableMultipleSoundPlayback, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_DefaultVolume, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(UAtomComponent, 643244024);
