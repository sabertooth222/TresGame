...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UMatineeTrackAtomCueId()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_CueSheet = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("CueSheet"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(CueSheet, UMatineeTrackAtomCueId), 0x0010000000000005, Z_Construct_UClass_USoundAtomCueSheet_NoRegister());
				UProperty* NewProp_SelectorList = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("SelectorList"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(SelectorList, UMatineeTrackAtomCueId), 0x0010000000000005);
				...
				UProperty* NewProp_AisacList = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("AisacList"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(AisacList, UMatineeTrackAtomCueId), 0x0010000000000005);
	...
	IMPLEMENT_CLASS(UMatineeTrackAtomCueId, 3983836944);
