...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UAtomListenerFocusPoint()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_DirectionFocusLevel = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("DirectionFocusLevel"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(DirectionFocusLevel, UAtomListenerFocusPoint), 0x0010000000000005);
				UProperty* NewProp_DistanceFocusLevel = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("DistanceFocusLevel"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(DistanceFocusLevel, UAtomListenerFocusPoint), 0x0010000000000005);
				...
				MetaData->SetValue(NewProp_DirectionFocusLevel, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_DistanceFocusLevel, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(UAtomListenerFocusPoint, 2442988139);
