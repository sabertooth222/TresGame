...
static struct FScriptStruct_CriWareRuntime_StaticRegisterNativesFAtomCueNameTrackKeyframe
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FAtomCueNameTrackKeyframe()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_CueName = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("CueName"), RF_Public|RF_Transient|RF_MarkAsNative) UStrProperty(CPP_PROPERTY_BASE(CueName, FAtomCueNameTrackKeyframe), 0x0010000000000005);
			UProperty* NewProp_Time = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Time"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Time, FAtomCueNameTrackKeyframe), 0x0010000000000005);
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("BlueprintType"), TEXT("true"));
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/AtomCueNameTrackKeyframe.h"));
			MetaData->SetValue(NewProp_CueName, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FAtomCueNameTrackKeyframe_CRC() { return 2750712272U; }
