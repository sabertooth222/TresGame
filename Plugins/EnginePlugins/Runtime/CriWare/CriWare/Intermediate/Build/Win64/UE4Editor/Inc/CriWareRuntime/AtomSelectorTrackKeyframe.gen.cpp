...
static struct FScriptStruct_CriWareRuntime_StaticRegisterNativesFAtomSelectorTrackKeyframe
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FAtomSelectorTrackKeyframe()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_SelectorLabel = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("SelectorLabel"), RF_Public|RF_Transient|RF_MarkAsNative) UStrProperty(CPP_PROPERTY_BASE(SelectorLabel, FAtomSelectorTrackKeyframe), 0x0010000000000005);
			UProperty* NewProp_Time = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Time"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Time, FAtomSelectorTrackKeyframe), 0x0010000000000005);
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("BlueprintType"), TEXT("true"));
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/AtomSelectorTrackKeyframe.h"));
			MetaData->SetValue(NewProp_SelectorLabel, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FAtomSelectorTrackKeyframe_CRC() { return 2973388225U; }
