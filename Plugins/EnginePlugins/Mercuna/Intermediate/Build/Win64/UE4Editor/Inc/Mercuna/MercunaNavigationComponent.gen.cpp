...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UMercunaNavigationComponent()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UMercunaNavigationComponent_CheckReachable(), "CheckReachable"); // 2938453386
				...
				MetaData->SetValue(NewProp_DynamicAvoidance, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_Pathfinding, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(UMercunaNavigationComponent, 2017624841);
