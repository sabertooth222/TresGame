...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UMerNavOctreeRenderingComponent()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_SelectionMaterial = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("SelectionMaterial"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(SelectionMaterial, UMerNavOctreeRenderingComponent), 0x0010000000000005, Z_Construct_UClass_UMaterialInterface_NoRegister());
				UProperty* NewProp_Material = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Material"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(Material, UMerNavOctreeRenderingComponent), 0x0010000000000005, Z_Construct_UClass_UMaterialInterface_NoRegister());
				...
				MetaData->SetValue(NewProp_SelectionMaterial, TEXT("Category"), TEXT("MerNavOctreeRenderingComponent"));
				MetaData->SetValue(NewProp_SelectionMaterial, TEXT("ModuleRelativePath"), TEXT("Public/MerNavOctreeRenderingComponent.h"));
				MetaData->SetValue(NewProp_Material, TEXT("Category"), TEXT("MerNavOctreeRenderingComponent"));
	...
	IMPLEMENT_CLASS(UMerNavOctreeRenderingComponent, 1540006757);
