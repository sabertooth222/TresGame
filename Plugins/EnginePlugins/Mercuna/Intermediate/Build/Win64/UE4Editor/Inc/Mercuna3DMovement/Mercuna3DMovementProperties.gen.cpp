...
static struct FScriptStruct_Mercuna3DMovement_StaticRegisterNativesFMercuna3DMovementProperties
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMercuna3DMovementProperties()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_MaxAngAccel = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("MaxAngAccel"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaxAngAccel, FMercuna3DMovementProperties), 0x0010000000000005);
			UProperty* NewProp_MaxAngSpeed = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("MaxAngSpeed"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaxAngSpeed, FMercuna3DMovementProperties), 0x0010000000000005);
			UProperty* NewProp_MaxAccel = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("MaxAccel"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(MaxAccel, FMercuna3DMovementProperties), 0x0010000000000005, Z_Construct_UScriptStruct_FVector());
			UProperty* NewProp_MaxSpeed = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("MaxSpeed"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaxSpeed, FMercuna3DMovementProperties), 0x0010000000000005);
	...
	uint32 Get_Z_Construct_UScriptStruct_FMercuna3DMovementProperties_CRC() { return 2345709925U; }
