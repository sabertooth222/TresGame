...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UMerSettings()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_MaxPawnRadius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MaxPawnRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(MaxPawnRadius, UMerSettings), 0x0010000000004005);
				UProperty* NewProp_MinPawnRadius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MinPawnRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(MinPawnRadius, UMerSettings), 0x0010000000004005);
				UProperty* NewProp_CellSize = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("CellSize"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(CellSize, UMerSettings), 0x0010000000004005);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bAlwaysShowErrors, UMerSettings);
				UProperty* NewProp_bAlwaysShowErrors = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bAlwaysShowErrors"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bAlwaysShowErrors, UMerSettings), 0x0010000000004005, CPP_BOOL_PROPERTY_BITMASK(bAlwaysShowErrors, UMerSettings), sizeof(bool), true);
				UProperty* NewProp_DebugLengthScale = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("DebugLengthScale"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(DebugLengthScale, UMerSettings), 0x0010000000004005);
	...
	IMPLEMENT_CLASS(UMerSettings, 4108591271);
