...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UBTTask_Mercuna_MoveTo()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_EndDistance = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("EndDistance"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(EndDistance, UBTTask_Mercuna_MoveTo), 0x0010000000000005);
				UProperty* NewProp_Speed = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Speed"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Speed, UBTTask_Mercuna_MoveTo), 0x0010000000000005);
				...
				MetaData->SetValue(NewProp_EndDistance, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(UBTTask_Mercuna_MoveTo, 3651468706);
