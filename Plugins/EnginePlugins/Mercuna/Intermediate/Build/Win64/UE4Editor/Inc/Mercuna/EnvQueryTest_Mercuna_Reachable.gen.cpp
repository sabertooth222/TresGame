...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UEnvQueryTest_Mercuna_Reachable()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_Context = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Context"), RF_Public|RF_Transient|RF_MarkAsNative) UClassProperty(CPP_PROPERTY_BASE(Context, UEnvQueryTest_Mercuna_Reachable), 0x0014000000000005, Z_Construct_UClass_UEnvQueryContext_NoRegister(), Z_Construct_UClass_UClass());
				UProperty* NewProp_MaxPathLength = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MaxPathLength"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(MaxPathLength, UEnvQueryTest_Mercuna_Reachable), 0x0010008000000005, Z_Construct_UScriptStruct_FAIDataProviderFloatValue());
	...
	IMPLEMENT_CLASS(UEnvQueryTest_Mercuna_Reachable, 2597746757);
