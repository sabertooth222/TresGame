...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UEnvQueryGenerator_Mercuna_3DRing()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_center = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("center"), RF_Public|RF_Transient|RF_MarkAsNative) UClassProperty(CPP_PROPERTY_BASE(center, UEnvQueryGenerator_Mercuna_3DRing), 0x0014000000000005, Z_Construct_UClass_UEnvQueryContext_NoRegister(), Z_Construct_UClass_UClass());
				UProperty* NewProp_NumberOfLayers = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("NumberOfLayers"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(NumberOfLayers, UEnvQueryGenerator_Mercuna_3DRing), 0x0010008000000005, Z_Construct_UScriptStruct_FAIDataProviderIntValue());
				UProperty* NewProp_MaxHeight = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MaxHeight"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(MaxHeight, UEnvQueryGenerator_Mercuna_3DRing), 0x0010008000000005, Z_Construct_UScriptStruct_FAIDataProviderFloatValue());
				UProperty* NewProp_MinHeight = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MinHeight"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(MinHeight, UEnvQueryGenerator_Mercuna_3DRing), 0x0010008000000005, Z_Construct_UScriptStruct_FAIDataProviderFloatValue());
				UProperty* NewProp_PointsPerRing = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("PointsPerRing"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(PointsPerRing, UEnvQueryGenerator_Mercuna_3DRing), 0x0010008000000005, Z_Construct_UScriptStruct_FAIDataProviderIntValue());
				UProperty* NewProp_NumberOfRings = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("NumberOfRings"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(NumberOfRings, UEnvQueryGenerator_Mercuna_3DRing), 0x0010008000000005, Z_Construct_UScriptStruct_FAIDataProviderIntValue());
				UProperty* NewProp_OuterRadius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OuterRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(OuterRadius, UEnvQueryGenerator_Mercuna_3DRing), 0x0010008000000005, Z_Construct_UScriptStruct_FAIDataProviderFloatValue());
				UProperty* NewProp_InnerRadius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("InnerRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(InnerRadius, UEnvQueryGenerator_Mercuna_3DRing), 0x0010008000000005, Z_Construct_UScriptStruct_FAIDataProviderFloatValue());
				...
				MetaData->SetValue(NewProp_center, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_NumberOfLayers, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_MaxHeight, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_MinHeight, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_PointsPerRing, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_NumberOfRings, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_OuterRadius, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_InnerRadius, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(UEnvQueryGenerator_Mercuna_3DRing, 2482099725);
