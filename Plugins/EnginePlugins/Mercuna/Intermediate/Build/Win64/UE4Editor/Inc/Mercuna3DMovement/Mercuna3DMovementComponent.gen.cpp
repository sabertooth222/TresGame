...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UMercuna3DMovementComponent()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_AngularVelocity = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("AngularVelocity"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(AngularVelocity, UMercuna3DMovementComponent), 0x0020080000002004, Z_Construct_UScriptStruct_FVector());
				UProperty* NewProp_Acceleration = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Acceleration"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(Acceleration, UMercuna3DMovementComponent), 0x0020080000002004, Z_Construct_UScriptStruct_FVector());
	...
	IMPLEMENT_CLASS(UMercuna3DMovementComponent, 1737933925);
