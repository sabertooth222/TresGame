...
static struct FScriptStruct_Mercuna_StaticRegisterNativesFMercunaMoveRequest
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMercunaMoveRequest()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_GoalActor = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("GoalActor"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(GoalActor, FMercunaMoveRequest), 0x0010000000000004, Z_Construct_UClass_AActor_NoRegister());
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("BlueprintType"), TEXT("true"));
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/MercunaMoveRequest.h"));
			MetaData->SetValue(NewProp_GoalActor, TEXT("Category"), TEXT("MercunaMoveRequest"));
			MetaData->SetValue(NewProp_GoalActor, TEXT("ModuleRelativePath"), TEXT("Public/MercunaMoveRequest.h"));
#endif
		}
		return ReturnStruct;
	}
	uint32 Get_Z_Construct_UScriptStruct_FMercunaMoveRequest_CRC() { return 3676113003U; }
