...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UEnvQueryTest_Mercuna_NavRaycast()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_Context = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Context"), RF_Public|RF_Transient|RF_MarkAsNative) UClassProperty(CPP_PROPERTY_BASE(Context, UEnvQueryTest_Mercuna_NavRaycast), 0x0014000000000005, Z_Construct_UClass_UEnvQueryContext_NoRegister(), Z_Construct_UClass_UClass());
	...
	IMPLEMENT_CLASS(UEnvQueryTest_Mercuna_NavRaycast, 2257344321);
