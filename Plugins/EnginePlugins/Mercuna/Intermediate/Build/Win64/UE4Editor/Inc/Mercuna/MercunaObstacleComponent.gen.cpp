...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UMercunaObstacleComponent()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_Radius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Radius"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Radius, UMercunaObstacleComponent), 0x0010000000000005);
				UProperty* NewProp_Type = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Type"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(Type, UMercunaObstacleComponent), 0x0010000000000005, Z_Construct_UEnum_Mercuna_EMerObstacleType());
				...
				MetaData->SetValue(NewProp_Type, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(UMercunaObstacleComponent, 3180329055);
