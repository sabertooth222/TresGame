...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UEnvQueryGenerator_Mercuna_Sphere()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_center = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("center"), RF_Public|RF_Transient|RF_MarkAsNative) UClassProperty(CPP_PROPERTY_BASE(center, UEnvQueryGenerator_Mercuna_Sphere), 0x0014000000000005, Z_Construct_UClass_UEnvQueryContext_NoRegister(), Z_Construct_UClass_UClass());
				UProperty* NewProp_Distribution = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Distribution"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(Distribution, UEnvQueryGenerator_Mercuna_Sphere), 0x0010000000000005, Z_Construct_UEnum_Mercuna_EMercunaPointDistribution());
				...
				UProperty* NewProp_PointsPerShell = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("PointsPerShell"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(PointsPerShell, UEnvQueryGenerator_Mercuna_Sphere), 0x0010008000000005, Z_Construct_UScriptStruct_FAIDataProviderIntValue());
				UProperty* NewProp_NumberOfShells = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("NumberOfShells"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(NumberOfShells, UEnvQueryGenerator_Mercuna_Sphere), 0x0010008000000005, Z_Construct_UScriptStruct_FAIDataProviderIntValue());
				UProperty* NewProp_OuterRadius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OuterRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(OuterRadius, UEnvQueryGenerator_Mercuna_Sphere), 0x0010008000000005, Z_Construct_UScriptStruct_FAIDataProviderFloatValue());
				UProperty* NewProp_InnerRadius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("InnerRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(InnerRadius, UEnvQueryGenerator_Mercuna_Sphere), 0x0010008000000005, Z_Construct_UScriptStruct_FAIDataProviderFloatValue());
				...
				MetaData->SetValue(NewProp_Distribution, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_PointsPerShell, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_NumberOfShells, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(UEnvQueryGenerator_Mercuna_Sphere, 1191033209);
