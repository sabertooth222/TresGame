...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UEnvQueryTest_Mercuna_Project()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_Context = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Context"), RF_Public|RF_Transient|RF_MarkAsNative) UClassProperty(CPP_PROPERTY_BASE(Context, UEnvQueryTest_Mercuna_Project), 0x0014000000000005, Z_Construct_UClass_UEnvQueryContext_NoRegister(), Z_Construct_UClass_UClass());
				UProperty* NewProp_MaxSearchRadius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MaxSearchRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(MaxSearchRadius, UEnvQueryTest_Mercuna_Project), 0x0010008000000005, Z_Construct_UScriptStruct_FAIDataProviderFloatValue());
				...
				MetaData->SetValue(NewProp_MaxSearchRadius, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(UEnvQueryTest_Mercuna_Project, 3612854646);
