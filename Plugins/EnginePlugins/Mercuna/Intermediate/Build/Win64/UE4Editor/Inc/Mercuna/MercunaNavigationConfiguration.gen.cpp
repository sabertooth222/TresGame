...
static struct FScriptStruct_Mercuna_StaticRegisterNativesFMercunaNavigationConfiguration
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FMercunaNavigationConfiguration()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_StopAtDestination = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("StopAtDestination"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(StopAtDestination, FMercunaNavigationConfiguration), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(StopAtDestination, FMercunaNavigationConfiguration), sizeof(bool), true);
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(MoveOnlyInLookDirection, FMercunaNavigationConfiguration);
			UProperty* NewProp_MoveOnlyInLookDirection = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("MoveOnlyInLookDirection"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(MoveOnlyInLookDirection, FMercunaNavigationConfiguration), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(MoveOnlyInLookDirection, FMercunaNavigationConfiguration), sizeof(bool), true);
			UProperty* NewProp_MaxRoll = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("MaxRoll"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaxRoll, FMercunaNavigationConfiguration), 0x0010000000000005);
			UProperty* NewProp_MaxPitch = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("MaxPitch"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaxPitch, FMercunaNavigationConfiguration), 0x0010000000000005);
			...
			MetaData->SetValue(NewProp_StopAtDestination, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
			...
			MetaData->SetValue(NewProp_MoveOnlyInLookDirection, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
			...
			MetaData->SetValue(NewProp_MaxRoll, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
			...
			MetaData->SetValue(NewProp_MaxPitch, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FMercunaNavigationConfiguration_CRC() { return 3217127143U; }
