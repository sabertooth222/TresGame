...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AMercunaNavVolume()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_NavOctree = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("NavOctree"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(NavOctree, AMercunaNavVolume), 0x0040000000000004, Z_Construct_UClass_AMercunaNavOctree_NoRegister());
				...
				MetaData->SetValue(NewProp_NavOctree, TEXT("AllowPrivateAccess"), TEXT("true"));
				MetaData->SetValue(NewProp_NavOctree, TEXT("Category"), TEXT("MercunaNavVolume"));
	...
	IMPLEMENT_CLASS(AMercunaNavVolume, 3095477649);
