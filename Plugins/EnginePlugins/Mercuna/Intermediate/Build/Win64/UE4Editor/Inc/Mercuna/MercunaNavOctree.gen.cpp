...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AMercunaNavOctree()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_bNeedsRebuild = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bNeedsRebuild"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bNeedsRebuild, AMercunaNavOctree), 0x0040000000000004, CPP_BOOL_PROPERTY_BITMASK(bNeedsRebuild, AMercunaNavOctree), sizeof(bool), true);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bBuildAsSublevel, AMercunaNavOctree);
				UProperty* NewProp_bBuildAsSublevel = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bBuildAsSublevel"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bBuildAsSublevel, AMercunaNavOctree), 0x0040000000000004, CPP_BOOL_PROPERTY_BITMASK(bBuildAsSublevel, AMercunaNavOctree), sizeof(bool), true);
				UProperty* NewProp_MerNavOctreeRenderingComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MerNavOctreeRenderingComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(MerNavOctreeRenderingComponent, AMercunaNavOctree), 0x004200000008200c, Z_Construct_UClass_UMerNavOctreeRenderingComponent_NoRegister());
				UProperty* NewProp_DebugDrawMode = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("DebugDrawMode"), RF_Public|RF_Transient|RF_MarkAsNative) UEnumProperty(CPP_PROPERTY_BASE(DebugDrawMode, AMercunaNavOctree), 0x0040000000002004, Z_Construct_UEnum_Mercuna_EMerOctreeDebugDrawMode());
				...
				UProperty* NewProp_MaxPawnRadius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MaxPawnRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(MaxPawnRadius, AMercunaNavOctree), 0x0010000000004005);
				UProperty* NewProp_MinPawnRadius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("MinPawnRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(MinPawnRadius, AMercunaNavOctree), 0x0010000000004005);
				UProperty* NewProp_CellSize = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("CellSize"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(CellSize, AMercunaNavOctree), 0x0010000000004005);
				...
				MetaData->SetValue(NewProp_bNeedsRebuild, TEXT("AllowPrivateAccess"), TEXT("true"));
				MetaData->SetValue(NewProp_bNeedsRebuild, TEXT("Category"), TEXT("MercunaNavOctree"));
				MetaData->SetValue(NewProp_bNeedsRebuild, TEXT("ModuleRelativePath"), TEXT("Public/MercunaNavOctree.h"));
				MetaData->SetValue(NewProp_bBuildAsSublevel, TEXT("AllowPrivateAccess"), TEXT("true"));
				MetaData->SetValue(NewProp_bBuildAsSublevel, TEXT("Category"), TEXT("MercunaNavOctree"));
				MetaData->SetValue(NewProp_bBuildAsSublevel, TEXT("ModuleRelativePath"), TEXT("Public/MercunaNavOctree.h"));
				MetaData->SetValue(NewProp_MerNavOctreeRenderingComponent, TEXT("AllowPrivateAccess"), TEXT("true"));
				MetaData->SetValue(NewProp_MerNavOctreeRenderingComponent, TEXT("Category"), TEXT("MercunaNavOctree"));
				...
				MetaData->SetValue(NewProp_DebugDrawMode, TEXT("AllowPrivateAccess"), TEXT("true"));
				MetaData->SetValue(NewProp_DebugDrawMode, TEXT("Category"), TEXT("MercunaNavOctree"));
	...
	IMPLEMENT_CLASS(AMercunaNavOctree, 1329173624);
