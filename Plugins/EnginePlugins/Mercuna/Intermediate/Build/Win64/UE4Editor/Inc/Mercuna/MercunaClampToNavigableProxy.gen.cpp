...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_UMercunaClampToNavigableProxy_MercunaClampToNavigable()
	{
		...
		if (!ReturnFunction)
		{
			...
			MetaData->SetValue(ReturnFunction, TEXT("Category"), TEXT("Mercuna"));
	...
	UClass* Z_Construct_UClass_UMercunaClampToNavigableProxy()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_OnFailure = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnFailure"), RF_Public|RF_Transient|RF_MarkAsNative) UMulticastDelegateProperty(CPP_PROPERTY_BASE(OnFailure, UMercunaClampToNavigableProxy), 0x0010100010080000, Z_Construct_UDelegateFunction_Mercuna_MercunaClampToNavigableResult__DelegateSignature());
				UProperty* NewProp_OnSuccess = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnSuccess"), RF_Public|RF_Transient|RF_MarkAsNative) UMulticastDelegateProperty(CPP_PROPERTY_BASE(OnSuccess, UMercunaClampToNavigableProxy), 0x0010100010080000, Z_Construct_UDelegateFunction_Mercuna_MercunaClampToNavigableResult__DelegateSignature());
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UMercunaClampToNavigableProxy_MercunaClampToNavigable(), "MercunaClampToNavigable"); // 3630010047
	...
	IMPLEMENT_CLASS(UMercunaClampToNavigableProxy, 1137799293);
