...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_AMercunaNavTestingActor()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_OtherActor = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OtherActor"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(OtherActor, AMercunaNavTestingActor), 0x0010000000000005, Z_Construct_UClass_AMercunaNavTestingActor_NoRegister());
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bSearchStart, AMercunaNavTestingActor);
				UProperty* NewProp_bSearchStart = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bSearchStart"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bSearchStart, AMercunaNavTestingActor), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(bSearchStart, AMercunaNavTestingActor), sizeof(uint8), false);
				UProperty* NewProp_Radius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Radius"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Radius, AMercunaNavTestingActor), 0x0010000000000005);
				...
				MetaData->SetValue(NewProp_OtherActor, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_bSearchStart, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_Radius, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(AMercunaNavTestingActor, 2814365791);
