...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_USQEXSEADSound()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_SoundIndex = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("SoundIndex"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(SoundIndex, USQEXSEADSound), 0x0010010000000004);
				UProperty* NewProp_ReferenceBank = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ReferenceBank"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(ReferenceBank, USQEXSEADSound), 0x0010010000000004, Z_Construct_UClass_USQEXSEADSoundBank_NoRegister());
	...
	IMPLEMENT_CLASS(USQEXSEADSound, 389916358);
