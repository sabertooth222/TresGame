...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_USQEXSEADBGMSlot()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_PrevBGM_ = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("PrevBGM_"), RF_Public|RF_Transient|RF_MarkAsNative) UAssetObjectProperty(CPP_PROPERTY_BASE(PrevBGM_, USQEXSEADBGMSlot), 0x0044000000000000, Z_Construct_UClass_USQEXSEAD_BGM_NoRegister());
				UProperty* NewProp_BGM_ = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("BGM_"), RF_Public|RF_Transient|RF_MarkAsNative) UAssetObjectProperty(CPP_PROPERTY_BASE(BGM_, USQEXSEADBGMSlot), 0x0044000000000000, Z_Construct_UClass_USQEXSEAD_BGM_NoRegister());
	...
	IMPLEMENT_CLASS(USQEXSEADBGMSlot, 1178741453);
