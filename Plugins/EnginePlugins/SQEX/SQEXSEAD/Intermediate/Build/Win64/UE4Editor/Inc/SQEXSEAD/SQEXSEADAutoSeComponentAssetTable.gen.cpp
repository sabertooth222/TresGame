...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_USQEXSEADAutoSeComponentAssetTable()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_AuxSurfaceAssetTable = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("AuxSurfaceAssetTable"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(AuxSurfaceAssetTable, USQEXSEADAutoSeComponentAssetTable), 0x0010000000000005, Z_Construct_UScriptStruct_FSQEXSEADSurfaceAssetReferenceTableData());
				UProperty* NewProp_NonSurfaceInfos = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("NonSurfaceInfos"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(NonSurfaceInfos, USQEXSEADAutoSeComponentAssetTable), 0x0010000000000005, Z_Construct_UScriptStruct_FSQEXSEADAutoSeComponentAssetTableNonSurface());
				...
				MetaData->SetValue(NewProp_AuxSurfaceAssetTable, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_NonSurfaceInfos, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_PerSurfaceInfos, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(USQEXSEADAutoSeComponentAssetTable, 2112984945);
