...
static struct FScriptStruct_SQEXSEAD_StaticRegisterNativesFSQEXSEADSoundReference
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FSQEXSEADSoundReference()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_AttachPointName = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("AttachPointName"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(CPP_PROPERTY_BASE(AttachPointName, FSQEXSEADSoundReference), 0x0010000000000005);
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bFollow, FSQEXSEADSoundReference);
			UProperty* NewProp_bFollow = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("bFollow"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bFollow, FSQEXSEADSoundReference), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(bFollow, FSQEXSEADSoundReference), sizeof(uint8), false);
			UProperty* NewProp_Sound = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Sound"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(Sound, FSQEXSEADSoundReference), 0x0010000000000005, Z_Construct_UClass_USoundBase_NoRegister());
	...
	uint32 Get_Z_Construct_UScriptStruct_FSQEXSEADSoundReference_CRC() { return 489695005U; }
