...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_USQEXSEADInterpTrackCategoryVolumeFade()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_OnMatineeEndSetCategoryVolume = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnMatineeEndSetCategoryVolume"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(OnMatineeEndSetCategoryVolume, USQEXSEADInterpTrackCategoryVolumeFade), 0x0010000000000005);
				UProperty* NewProp_ExtendCategoryNames = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ExtendCategoryNames"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(ExtendCategoryNames, USQEXSEADInterpTrackCategoryVolumeFade), 0x0010000000000005);
				...
				UProperty* NewProp_CategoryName = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("CategoryName"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(CPP_PROPERTY_BASE(CategoryName, USQEXSEADInterpTrackCategoryVolumeFade), 0x0010000000000005);
				...
				MetaData->SetValue(NewProp_OnMatineeEndSetCategoryVolume, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_ExtendCategoryNames, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_CategoryName, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(USQEXSEADInterpTrackCategoryVolumeFade, 1875988992);
