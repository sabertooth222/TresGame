...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_USQEXSEADCollisionEventSeComponent()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_OnFractureSoundAsset = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnFractureSoundAsset"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(OnFractureSoundAsset, USQEXSEADCollisionEventSeComponent), 0x0010000000000005, Z_Construct_UClass_USoundBase_NoRegister());
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bPawnOverlapOnly, USQEXSEADCollisionEventSeComponent);
				UProperty* NewProp_bPawnOverlapOnly = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bPawnOverlapOnly"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bPawnOverlapOnly, USQEXSEADCollisionEventSeComponent), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(bPawnOverlapOnly, USQEXSEADCollisionEventSeComponent), sizeof(uint8), false);
				UProperty* NewProp_OnEndOverlapSoundAsset = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnEndOverlapSoundAsset"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(OnEndOverlapSoundAsset, USQEXSEADCollisionEventSeComponent), 0x0010000000000005, Z_Construct_UClass_USoundBase_NoRegister());
				UProperty* NewProp_OnBeginOverlapSoundAsset = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnBeginOverlapSoundAsset"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(OnBeginOverlapSoundAsset, USQEXSEADCollisionEventSeComponent), 0x0010000000000005, Z_Construct_UClass_USoundBase_NoRegister());
				UProperty* NewProp_HitDistanceThreshold = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("HitDistanceThreshold"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(HitDistanceThreshold, USQEXSEADCollisionEventSeComponent), 0x0010000000000005);
				UProperty* NewProp_OnPawnHitSoundAsset = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnPawnHitSoundAsset"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(OnPawnHitSoundAsset, USQEXSEADCollisionEventSeComponent), 0x0010000000000005, Z_Construct_UClass_USoundBase_NoRegister());
				UProperty* NewProp_OnHitSoundAsset = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnHitSoundAsset"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(OnHitSoundAsset, USQEXSEADCollisionEventSeComponent), 0x0010000000000005, Z_Construct_UClass_USoundBase_NoRegister());
				...
				MetaData->SetValue(NewProp_OnFractureSoundAsset, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_bPawnOverlapOnly, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_OnEndOverlapSoundAsset, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_OnBeginOverlapSoundAsset, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_HitDistanceThreshold, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_OnPawnHitSoundAsset, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_OnHitSoundAsset, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(USQEXSEADCollisionEventSeComponent, 878453496);
