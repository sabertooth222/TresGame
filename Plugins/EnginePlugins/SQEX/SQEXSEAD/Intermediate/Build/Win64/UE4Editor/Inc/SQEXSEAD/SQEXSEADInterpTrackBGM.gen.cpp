...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_USQEXSEADInterpTrackBGM()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_OnMatineeEndSetVolume = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OnMatineeEndSetVolume"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(OnMatineeEndSetVolume, USQEXSEADInterpTrackBGM), 0x0010000000000005);
				...
				MetaData->SetValue(NewProp_OnMatineeEndSetVolume, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(USQEXSEADInterpTrackBGM, 1398622373);
