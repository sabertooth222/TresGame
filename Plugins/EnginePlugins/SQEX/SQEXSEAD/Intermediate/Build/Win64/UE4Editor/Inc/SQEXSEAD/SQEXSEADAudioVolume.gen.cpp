...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_ASQEXSEADAudioVolume()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_VolumeComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("VolumeComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(VolumeComponent, ASQEXSEADAudioVolume), 0x00120000000a000d, Z_Construct_UClass_USQEXSEADVolumeComponent_NoRegister());
	...
	IMPLEMENT_CLASS(ASQEXSEADAudioVolume, 2363581186);
