...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_ASQEXSEADMusicActor()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_AudioComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("AudioComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(AudioComponent, ASQEXSEADMusicActor), 0x00100000000a000d, Z_Construct_UClass_UAudioComponent_NoRegister());
	...
	IMPLEMENT_CLASS(ASQEXSEADMusicActor, 2984277592);
