...
static struct FScriptStruct_SQEXSEAD_StaticRegisterNativesFSQEXSEADSurfaceAssetReferenceTableData
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FSQEXSEADSurfaceAssetReferenceTableData()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_Records = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Records"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(Records, FSQEXSEADSurfaceAssetReferenceTableData), 0x0010000000000005);
			...
			MetaData->SetValue(NewProp_Records, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FSQEXSEADSurfaceAssetReferenceTableData_CRC() { return 505688841U; }
