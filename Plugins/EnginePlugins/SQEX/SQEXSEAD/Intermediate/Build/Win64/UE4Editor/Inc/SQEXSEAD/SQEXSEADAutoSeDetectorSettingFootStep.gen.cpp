...
static struct FScriptStruct_SQEXSEAD_StaticRegisterNativesFSQEXSEADAutoSeDetectorSettingFootStep
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FSQEXSEADAutoSeDetectorSettingFootStep()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_bOverrideFootShuffleDetectFootAccelThreshold = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("bOverrideFootShuffleDetectFootAccelThreshold"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bOverrideFootShuffleDetectFootAccelThreshold, FSQEXSEADAutoSeDetectorSettingFootStep), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(bOverrideFootShuffleDetectFootAccelThreshold, FSQEXSEADAutoSeDetectorSettingFootStep), sizeof(bool), true);
			UProperty* NewProp_FootShuffleAssumeBodyStopVelocityThreshold = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("FootShuffleAssumeBodyStopVelocityThreshold"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(FootShuffleAssumeBodyStopVelocityThreshold, FSQEXSEADAutoSeDetectorSettingFootStep), 0x0010000000000005);
			...
			MetaData->SetValue(NewProp_FootShuffleDetectFootAccelThreshold, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
			...
			MetaData->SetValue(NewProp_bOverrideFootShuffleDetectFootAccelThreshold, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
			...
			MetaData->SetValue(NewProp_FootShuffleAssumeBodyStopVelocityThreshold, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
			...
			MetaData->SetValue(NewProp_bOverrideFootShuffleAssumeBodyStopVelocityThreshold, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FSQEXSEADAutoSeDetectorSettingFootStep_CRC() { return 4002380948U; }
