...
static struct FScriptStruct_SQEXSEAD_StaticRegisterNativesFSQEXSEADLayoutObstructionInfo
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FSQEXSEADLayoutObstructionInfo()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_LinkedMeshActorList = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("LinkedMeshActorList"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(LinkedMeshActorList, FSQEXSEADLayoutObstructionInfo), 0x0010000000000005);
			...
			UProperty* NewProp_ObstructionPointLocations = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("ObstructionPointLocations"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(ObstructionPointLocations, FSQEXSEADLayoutObstructionInfo), 0x0010000000000005);
			...
			UProperty* NewProp_ObstructionType = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("ObstructionType"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(CPP_PROPERTY_BASE(ObstructionType, FSQEXSEADLayoutObstructionInfo), 0x0010000000000005, Z_Construct_UEnum_SQEXSEAD_ESQEXSEADLayoutObstructionType());
			...
			MetaData->SetValue(NewProp_LinkedMeshActorList, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
			...
			MetaData->SetValue(NewProp_ObstructionPointLocations, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
			...
			MetaData->SetValue(NewProp_ObstructionType, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FSQEXSEADLayoutObstructionInfo_CRC() { return 4251964931U; }
