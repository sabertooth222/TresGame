...
static struct FScriptStruct_SQEXSEAD_StaticRegisterNativesFSQEXSEADLayoutInfo
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FSQEXSEADLayoutInfo()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_LayoutPointLocations = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("LayoutPointLocations"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(LayoutPointLocations, FSQEXSEADLayoutInfo), 0x0010000000000005);
			...
			UProperty* NewProp_OcclusionVolume = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("OcclusionVolume"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(OcclusionVolume, FSQEXSEADLayoutInfo), 0x0010000000000005);
			UProperty* NewProp_OcclusionLPF = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("OcclusionLPF"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(OcclusionLPF, FSQEXSEADLayoutInfo), 0x0010000000000005);
			UProperty* NewProp_OuterRadius = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("OuterRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(OuterRadius, FSQEXSEADLayoutInfo), 0x0010000000000005);
			UProperty* NewProp_InnerRadius = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("InnerRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(InnerRadius, FSQEXSEADLayoutInfo), 0x0010000000000005);
			UProperty* NewProp_LayoutType = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("LayoutType"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(CPP_PROPERTY_BASE(LayoutType, FSQEXSEADLayoutInfo), 0x0010000000000005, Z_Construct_UEnum_SQEXSEAD_ESQEXSEADLayoutType());
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("BlueprintType"), TEXT("true"));
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/SQEXSEADLayoutInfo.h"));
			MetaData->SetValue(NewProp_LayoutPointLocations, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
			...
			MetaData->SetValue(NewProp_OcclusionVolume, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
			...
			MetaData->SetValue(NewProp_OcclusionLPF, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
			...
			MetaData->SetValue(NewProp_LayoutType, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FSQEXSEADLayoutInfo_CRC() { return 969005216U; }
