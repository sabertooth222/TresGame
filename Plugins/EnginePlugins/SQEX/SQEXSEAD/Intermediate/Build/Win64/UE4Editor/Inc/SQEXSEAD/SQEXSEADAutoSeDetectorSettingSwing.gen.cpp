...
static struct FScriptStruct_SQEXSEAD_StaticRegisterNativesFSQEXSEADAutoSeDetectorSettingSwing
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FSQEXSEADAutoSeDetectorSettingSwing()
	{
		...
		if (!ReturnStruct)
		{
			...
			MetaData->SetValue(NewProp_RubDetectVelocityThreshold, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
			...
			MetaData->SetValue(NewProp_bOverrideRubDetectVelocityThreshold, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
			...
			MetaData->SetValue(NewProp_KnockDetectVelocityThreshold, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
			...
			MetaData->SetValue(NewProp_bOverrideKnockDetectVelocityThreshold, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FSQEXSEADAutoSeDetectorSettingSwing_CRC() { return 181242623U; }
