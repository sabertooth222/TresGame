...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_USQEXSEADBGMSlotController_SetPath()
	{
		...
		{
			TAssetPtr<USoundBase> SoundReference;
		};
		UObject* Outer = Z_Construct_UClass_USQEXSEADBGMSlotController();
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			...
			UProperty* NewProp_SoundReference = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("SoundReference"), RF_Public|RF_Transient|RF_MarkAsNative) UAssetObjectProperty(CPP_PROPERTY_BASE(SoundReference, SQEXSEADBGMSlotController_eventSetPath_Parms), 0x0014000000000080, Z_Construct_UClass_USoundBase_NoRegister());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
	...
	UClass* Z_Construct_UClass_USQEXSEADBGMSlotController()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USQEXSEADBGMSlotController_SetPath(), "SetPath"); // 348795830
	...
	IMPLEMENT_CLASS(USQEXSEADBGMSlotController, 737093006);
