...
static struct FScriptStruct_SQEXSEAD_StaticRegisterNativesFSQEXSEADBGMControlTrackKey
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FSQEXSEADBGMControlTrackKey()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_ModeIndex = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("ModeIndex"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(ModeIndex, FSQEXSEADBGMControlTrackKey), 0x0010000000000005);
			UProperty* NewProp_SectionIndex = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("SectionIndex"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(SectionIndex, FSQEXSEADBGMControlTrackKey), 0x0010000000000005);
			UProperty* NewProp_SlotName = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("SlotName"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(CPP_PROPERTY_BASE(SlotName, FSQEXSEADBGMControlTrackKey), 0x0010000000000005);
			UProperty* NewProp_ControlType = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("ControlType"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(CPP_PROPERTY_BASE(ControlType, FSQEXSEADBGMControlTrackKey), 0x0010000000000005, Z_Construct_UEnum_SQEXSEAD_ESQEXSEADBGMControlTypes());
			UProperty* NewProp_Time = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Time"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Time, FSQEXSEADBGMControlTrackKey), 0x0010000000000005);
			...
			MetaData->SetValue(NewProp_ModeIndex, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
			...
			MetaData->SetValue(NewProp_SectionIndex, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
			...
			MetaData->SetValue(NewProp_SlotName, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
			...
			MetaData->SetValue(NewProp_ControlType, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FSQEXSEADBGMControlTrackKey_CRC() { return 2964460519U; }
