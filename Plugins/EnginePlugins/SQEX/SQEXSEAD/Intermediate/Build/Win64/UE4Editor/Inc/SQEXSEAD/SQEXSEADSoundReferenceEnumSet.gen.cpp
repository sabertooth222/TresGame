...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_USQEXSEADSoundReferenceEnumSet()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_References = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("References"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(References, USQEXSEADSoundReferenceEnumSet), 0x0010000000000005);
				...
				MetaData->SetValue(NewProp_References, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(USQEXSEADSoundReferenceEnumSet, 3511955954);
