...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_ASQEXSEADWhizSound()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_WhizComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("WhizComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(WhizComponent, ASQEXSEADWhizSound), 0x00120000000a000d, Z_Construct_UClass_USQEXSEADWhizSeComponent_NoRegister());
	...
	IMPLEMENT_CLASS(ASQEXSEADWhizSound, 3384224269);
