...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_USQEXSEADSurfaceAssetReferenceTable()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_TableData = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("TableData"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(TableData, USQEXSEADSurfaceAssetReferenceTable), 0x0010000000000005, Z_Construct_UScriptStruct_FSQEXSEADSurfaceAssetReferenceTableData());
				...
				MetaData->SetValue(NewProp_TableData, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(USQEXSEADSurfaceAssetReferenceTable, 3512515256);
