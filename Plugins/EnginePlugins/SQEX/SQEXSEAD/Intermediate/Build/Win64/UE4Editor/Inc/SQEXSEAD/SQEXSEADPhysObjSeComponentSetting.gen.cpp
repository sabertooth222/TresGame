...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_USQEXSEADPhysObjSeComponentSetting()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_VelocityAudioFadeOutTime = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("VelocityAudioFadeOutTime"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(VelocityAudioFadeOutTime, USQEXSEADPhysObjSeComponentSetting), 0x0010000000000005);
				UProperty* NewProp_VelocityThreshold = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("VelocityThreshold"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(VelocityThreshold, USQEXSEADPhysObjSeComponentSetting), 0x0010000000000005);
				UProperty* NewProp_HitDistanceThreshold = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("HitDistanceThreshold"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(HitDistanceThreshold, USQEXSEADPhysObjSeComponentSetting), 0x0010000000000005);
				UProperty* NewProp_HitImpulseThreshold = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("HitImpulseThreshold"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(HitImpulseThreshold, USQEXSEADPhysObjSeComponentSetting), 0x0010000000000005);
				UProperty* NewProp_VelocitySE = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("VelocitySE"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(VelocitySE, USQEXSEADPhysObjSeComponentSetting), 0x0010000000000005, Z_Construct_UClass_USoundBase_NoRegister());
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bEnableSwithHitSE, USQEXSEADPhysObjSeComponentSetting);
				UProperty* NewProp_bEnableSwithHitSE = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bEnableSwithHitSE"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bEnableSwithHitSE, USQEXSEADPhysObjSeComponentSetting), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(bEnableSwithHitSE, USQEXSEADPhysObjSeComponentSetting), sizeof(uint8), false);
				UProperty* NewProp_HitSE = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("HitSE"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(HitSE, USQEXSEADPhysObjSeComponentSetting), 0x0010000000000005, Z_Construct_UClass_USoundBase_NoRegister());
				...
				MetaData->SetValue(NewProp_VelocityAudioFadeOutTime, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_VelocityThreshold, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_HitImpulseThreshold, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_VelocitySE, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_bEnableSwithHitSE, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_HitSE, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(USQEXSEADPhysObjSeComponentSetting, 40201514);
