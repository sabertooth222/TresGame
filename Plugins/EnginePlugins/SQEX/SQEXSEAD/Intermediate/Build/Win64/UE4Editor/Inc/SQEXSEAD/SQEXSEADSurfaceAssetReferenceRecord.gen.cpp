...
static struct FScriptStruct_SQEXSEAD_StaticRegisterNativesFSQEXSEADSurfaceAssetReferenceRecord
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FSQEXSEADSurfaceAssetReferenceRecord()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_Name = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Name"), RF_Public|RF_Transient|RF_MarkAsNative) UNameProperty(CPP_PROPERTY_BASE(Name, FSQEXSEADSurfaceAssetReferenceRecord), 0x0010000000000005);
			...
			MetaData->SetValue(NewProp_AssetRefs, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FSQEXSEADSurfaceAssetReferenceRecord_CRC() { return 1002686208U; }
