...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_ASQEXSEADLayoutSound()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_LayoutComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("LayoutComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(LayoutComponent, ASQEXSEADLayoutSound), 0x00120000000a000d, Z_Construct_UClass_USQEXSEADLayoutComponent_NoRegister());
	...
	IMPLEMENT_CLASS(ASQEXSEADLayoutSound, 2215630124);
