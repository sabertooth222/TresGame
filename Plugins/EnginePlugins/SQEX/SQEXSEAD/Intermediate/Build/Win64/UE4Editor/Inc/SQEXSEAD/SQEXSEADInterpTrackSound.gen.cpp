...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_USQEXSEADInterpTrackSound()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_bTreatAsNonWorldSound = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bTreatAsNonWorldSound"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bTreatAsNonWorldSound, USQEXSEADInterpTrackSound), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(bTreatAsNonWorldSound, USQEXSEADInterpTrackSound), sizeof(uint8), false);
				...
				MetaData->SetValue(NewProp_bTreatAsNonWorldSound, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(USQEXSEADInterpTrackSound, 1220738051);
