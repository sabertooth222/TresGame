...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_USQEXSEADAutoSeDetectionSetting()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_DetectorSettingSwing = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("DetectorSettingSwing"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(DetectorSettingSwing, USQEXSEADAutoSeDetectionSetting), 0x0010000000000005, Z_Construct_UScriptStruct_FSQEXSEADAutoSeDetectorSettingSwing());
				UProperty* NewProp_DetectorSettingRustle = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("DetectorSettingRustle"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(DetectorSettingRustle, USQEXSEADAutoSeDetectionSetting), 0x0010000000000005, Z_Construct_UScriptStruct_FSQEXSEADAutoSeDetectorSettingRustle());
				UProperty* NewProp_DetectorSettingFootStep = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("DetectorSettingFootStep"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(DetectorSettingFootStep, USQEXSEADAutoSeDetectionSetting), 0x0010000000000005, Z_Construct_UScriptStruct_FSQEXSEADAutoSeDetectorSettingFootStep());
				UProperty* NewProp_AnalyzerSettingForMotionOnlyMode = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("AnalyzerSettingForMotionOnlyMode"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(AnalyzerSettingForMotionOnlyMode, USQEXSEADAutoSeDetectionSetting), 0x0010000000000005, Z_Construct_UScriptStruct_FSQEXSEADAutoSeAnalyzerSetting());
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(bUseAnalyzerSettingForMotionOnlyMode, USQEXSEADAutoSeDetectionSetting);
				UProperty* NewProp_bUseAnalyzerSettingForMotionOnlyMode = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("bUseAnalyzerSettingForMotionOnlyMode"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bUseAnalyzerSettingForMotionOnlyMode, USQEXSEADAutoSeDetectionSetting), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(bUseAnalyzerSettingForMotionOnlyMode, USQEXSEADAutoSeDetectionSetting), sizeof(bool), true);
				UProperty* NewProp_AnalyzerSetting = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("AnalyzerSetting"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(AnalyzerSetting, USQEXSEADAutoSeDetectionSetting), 0x0010000000000005, Z_Construct_UScriptStruct_FSQEXSEADAutoSeAnalyzerSetting());
				...
				MetaData->SetValue(NewProp_DetectorSettingSwing, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_DetectorSettingRustle, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_DetectorSettingFootStep, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_AnalyzerSettingForMotionOnlyMode, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_bUseAnalyzerSettingForMotionOnlyMode, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
				...
				MetaData->SetValue(NewProp_AnalyzerSetting, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(USQEXSEADAutoSeDetectionSetting, 297448171);
