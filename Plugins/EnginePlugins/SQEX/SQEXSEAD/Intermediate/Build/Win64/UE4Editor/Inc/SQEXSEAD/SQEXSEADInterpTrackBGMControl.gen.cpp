...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_USQEXSEADInterpTrackBGMControl()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				UProperty* NewProp_BGMAssetPtr = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("BGMAssetPtr"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(BGMAssetPtr, USQEXSEADInterpTrackBGMControl), 0x0010000000000005, Z_Construct_UClass_USoundBase_NoRegister());
				...
				MetaData->SetValue(NewProp_BGMAssetPtr, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	IMPLEMENT_CLASS(USQEXSEADInterpTrackBGMControl, 3677800323);
