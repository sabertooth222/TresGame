...
// End Cross Module References
	...
	UFunction* Z_Construct_UFunction_USQEXSEADStatics_ReadySetPathBGM()
	{
		...
		if (!ReturnFunction)
		{
			...
			UProperty* NewProp_SoundReference = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("SoundReference"), RF_Public|RF_Transient|RF_MarkAsNative) UAssetObjectProperty(CPP_PROPERTY_BASE(SoundReference, SQEXSEADStatics_eventReadySetPathBGM_Parms), 0x0014000000000080, Z_Construct_UClass_USoundBase_NoRegister());
	...
	UClass* Z_Construct_UClass_USQEXSEADStatics()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_USQEXSEADStatics_ReadySetPathBGM(), "ReadySetPathBGM"); // 1189425262
	...
	IMPLEMENT_CLASS(USQEXSEADStatics, 1661728747);
