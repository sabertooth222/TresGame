...
static struct FScriptStruct_SQEXSEAD_StaticRegisterNativesFSQEXSEADAutoSeComponentAssetTablePerSurface
{
	...
	UScriptStruct* Z_Construct_UScriptStruct_FSQEXSEADAutoSeComponentAssetTablePerSurface()
	{
		...
		if (!ReturnStruct)
		{
			...
			MetaData->SetValue(NewProp_SoundAssetPaths, TEXT("AllowPrivateAccess"), TEXT("TRUE"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FSQEXSEADAutoSeComponentAssetTablePerSurface_CRC() { return 2199066839U; }
