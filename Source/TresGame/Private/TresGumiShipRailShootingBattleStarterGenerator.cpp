...
ATresGumiShipRailShootingBattleStarterGenerator::ATresGumiShipRailShootingBattleStarterGenerator(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
