#include "TresGumiShipLevelEntityActivateVolume.h"

class UPrimitiveComponent;
class AActor;

void ATresGumiShipLevelEntityActivateVolume::_OnLeaveActivateVolume(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComponent, int32 OtherBodyIndex) {
}
