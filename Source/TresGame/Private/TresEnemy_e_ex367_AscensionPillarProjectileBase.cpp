...
ATresEnemy_e_ex367_AscensionPillarProjectileBase::ATresEnemy_e_ex367_AscensionPillarProjectileBase(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
