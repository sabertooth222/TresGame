...
#include "TresAttack6_e_ex361_DarkAuraKabutowariStart.generated.h"

UCLASS(Blueprintable, HideDropdown)
class UTresAttack6_e_ex361_DarkAuraKabutowariStart : public UTresAttackDefinitionBase {
    GENERATED_BODY()
public:
protected:
...
public:
    UTresAttack6_e_ex361_DarkAuraKabutowariStart();
};
