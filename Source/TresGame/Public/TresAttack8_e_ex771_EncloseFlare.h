...
#include "TresAttack8_e_ex771_EncloseFlare.generated.h"

UCLASS(Blueprintable, HideDropdown)
class UTresAttack8_e_ex771_EncloseFlare : public UTresAttackDefinitionBase {
    GENERATED_BODY()
public:
protected:
...
public:
    UTresAttack8_e_ex771_EncloseFlare();
};
