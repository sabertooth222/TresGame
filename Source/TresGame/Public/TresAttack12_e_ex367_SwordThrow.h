...
#include "TresAttack12_e_ex367_SwordThrow.generated.h"

class ATresProjectileBase;
class USoundBase;
class UEnvQuery;
class ATresEnemy_e_ex367_KeyBladeProjectileBase;

UCLASS(Blueprintable, HideDropdown)
class UTresAttack12_e_ex367_SwordThrow : public UTresAttackDefinitionBase {
    GENERATED_BODY()
public:
protected:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    float m_WarpOffsetDist;
...
private:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    ATresEnemy_e_ex367_KeyBladeProjectileBase* m_KeyBladeProjectile;
    
public:
    UTresAttack12_e_ex367_SwordThrow();
};
