...
#include "TresAttack1_e_ex358_JinraiSecond.generated.h"

UCLASS(Blueprintable, HideDropdown)
class UTresAttack1_e_ex358_JinraiSecond : public UTresAttack1_e_ex358_JinraiBase {
    GENERATED_BODY()
public:
private:
...
public:
    UTresAttack1_e_ex358_JinraiSecond();
};
