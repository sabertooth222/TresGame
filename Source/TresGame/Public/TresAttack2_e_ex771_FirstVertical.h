...
#include "TresAttack2_e_ex771_FirstVertical.generated.h"

UCLASS(Blueprintable, HideDropdown)
class UTresAttack2_e_ex771_FirstVertical : public UTresAttackDefinitionBase {
    GENERATED_BODY()
public:
protected:
...
public:
    UTresAttack2_e_ex771_FirstVertical();
};
