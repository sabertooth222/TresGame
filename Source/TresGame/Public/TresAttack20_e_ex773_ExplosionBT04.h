...
#include "TresEnemyEx773_AttractBT04Param.h"
#include "TresAttack20_e_ex773_ExplosionBT04.generated.h"

class UParticleSystemComponent;
class ATresActor_e_ex773_Attract;
class ATresProjectileGenerator_e_ex773_HvnDebris;
class ATresProjectile_e_ex773_ExplosionOmen;
class ATresProjectileGenerator_e_ex773_HvnDebrisBlow;
class UParticleSystem;

UCLASS(Blueprintable, HideDropdown)
class UTresAttack20_e_ex773_ExplosionBT04 : public UTresAttackDefinitionBase {
    GENERATED_BODY()
public:
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TArray<FTresEnemyEx773_AttractBT04Param> m_AttractParamArray;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    ATresProjectile_e_ex773_ExplosionOmen* m_ExplosionOmen;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    ATresProjectileGenerator_e_ex773_HvnDebris* m_HvnDebrisGenerator;
    
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    ATresProjectileGenerator_e_ex773_HvnDebrisBlow* m_HvnDebrisBlowGenerator;
...
protected:
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TSubclassOf<ATresProjectileGenerator_e_ex773_HvnDebris> m_pro_HvnDebrisGeneratorClass;
    ...
    UPROPERTY(BlueprintReadWrite, EditAnywhere, meta=(AllowPrivateAccess=true))
    TSubclassOf<ATresProjectileGenerator_e_ex773_HvnDebrisBlow> m_pro_HvnDebrisBlowGeneratorClass;
    
public:
    UTresAttack20_e_ex773_ExplosionBT04();
};
