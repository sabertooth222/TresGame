...
#include "TresAttack1_n_ex004_LandCombo.generated.h"

class UAnimSequenceBase;

UCLASS(Blueprintable, HideDropdown)
class UTresAttack1_n_ex004_LandCombo : public UTresNpcAttackDefinitionBase {
    GENERATED_BODY()
public:
protected:
...
public:
    UTresAttack1_n_ex004_LandCombo();
};
